...
namespace CleanArchitecture.Application.Features.Streamers.Commands.UpdateStreamer
{
    public class UpdateStreamerCommandHandler : IRequestHandler<UpdateStreamerCommand>
    {
        ...
        {
            Domain.Streamer streamerToUpdate = await _streamerRepository.GetByIdAsync(request.Id);
            ...
            _mapper.Map(request, streamerToUpdate, typeof(UpdateStreamerCommand), typeof(Domain.Streamer));
